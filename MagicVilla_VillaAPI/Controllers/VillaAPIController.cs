...
namespace MagicVilla_VillaAPI.Controllers
{
    ...
    public class VillaAPIController : ControllerBase
    {
        ...
        public async Task<ActionResult<VillaDTO>> GetVillaById(int id)
        {
            ...
            var villa = _db.Villas.FirstOrDefaultAsync(y => y.Id == id);
        ...
        public async Task<ActionResult<VillaDTO>> CreateVilla([FromBody] VillaCreateDTO createDTO)
        {
            ...
            if(await _db.Villas.FirstOrDefaultAsync(y => y.Name.ToLower() == createDTO.Name.ToLower()) != null){
        ...
        public async Task<IActionResult> UpdatePartialVilla(int id, JsonPatchDocument<VillaUpdateDTO> patchDTO)
        {
            ...
            var villa = await _db.Villas.AsNoTracking().FirstOrDefaultAsync(y => y.Id == id);
